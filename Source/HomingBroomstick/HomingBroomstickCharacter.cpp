...
#include "HomingBroomstickCharacter.h"
...
AHomingBroomstickCharacter::AHomingBroomstickCharacter()
{
...
void AHomingBroomstickCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	// Set up action bindings
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		// Jumping
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Started, this, &AHomingBroomstickCharacter::DoJumpStart);
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Completed, this, &AHomingBroomstickCharacter::DoJumpEnd);

		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AHomingBroomstickCharacter::MoveInput);
...
void AHomingBroomstickCharacter::MoveInput(const FInputActionValue& Value)
{
...
void AHomingBroomstickCharacter::LookInput(const FInputActionValue& Value)
{
...
void AHomingBroomstickCharacter::DoMove(float Right, float Forward)
{
	if (GetController())
	{
...
void AHomingBroomstickCharacter::DoJumpStart()
{
